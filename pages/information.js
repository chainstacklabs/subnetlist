          ...
          >
            ...
            <div className={classes.textContainer}>
              <Typography variant="body1">
                ...
                For example, X-Chain is an instance of AVM and C-Chain is Subnet
                EVM's instance.
              </Typography>
              <Typography variant="body1">
                <strong>
                ...
                All 3 blockchains are validated and secured by the Primary
                Network. The Primary Network is a special subnet, and all
                members of all custom subnets must also be a member of the
                Primary Network by staking at least 2,000 AVAX.
              </Typography>
              <Typography variant="body1">
                Avalanche enables you to create a subnet (dynamic set of
                validators) which validate blockchain with default, configured
                or custom Virtual Machine. Each blockchain is validated by
                exactly one subnet, while a subnet can validate many
                blockchains. A node can be member of many subnets.
              </Typography>
              <Typography variant="body1">
                Moreover, you can create a private subnet. It means that nodes
                will communicate with only each other within this subnet.
              </Typography>
              ...
              <Typography>
                For your own VM you need to implement interface for
                compatibility with AvalancheGo. You can find more{' '}
                <Link href="https://docs.avax.network/build/tutorials/platform/subnets/create-a-virtual-machine-vm">
                  information about VMs here
                </Link>
                .
              </Typography>
            </div>
